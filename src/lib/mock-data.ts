...
export const mockLines = [
    ...
    "Fan clutch",
    "Kit banda de accesorios",
    "Kit banda de distribución",
    "Kit banda de distribución con bomba",
    ...
    "Tensor de accesorios HD",
    "Toma de agua",
    "Toma de agua con termostato",
    "Tensor hidráulico",
    "Toma de agua conexión",
    "Toma de agua housing",
    "Tapón de depósito",
    "Tapón de radiador",
    "Condensador",
    "Herramienta",
